...
i = 0;
for success, info in bulk(_client,update_references(_index,'cluster_id','duplicate_id',get_duplicates,_featyp,_ngrams_n,[_configs],True),chunk_size=_chunk_size, request_timeout=_requestimeout):
    i += 1;
    if not success:
