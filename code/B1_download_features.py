        ...
        for doc in page['hits']['hits']:
            if refobj in doc['_source'] and isinstance(doc['_source'][refobj],list):
                for i in range(len(doc['_source'][refobj])):
                    ...
                    yield (linkID,refobj,sowiportID,crossrefID,dnbID,openalexID,arxivID,ssoarID,dataID,bibID,issue,volume,year,source,title,a1sur,a1init,a1first,a2sur,a2init,a2first,a3sur,a3init,a3first,a4sur,a4init,a4first,e1sur,e1init,e1first,publisher1,);
        scroll_tries = 0;
